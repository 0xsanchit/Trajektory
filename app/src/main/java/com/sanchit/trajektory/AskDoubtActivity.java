...
public class AskDoubtActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment selectedfragment=new AskDoubtFragment();
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    selectedfragment=new AskDoubtFragment();
                    break;
                case R.id.navigation_dashboard:
                    selectedfragment=new PreviousDoubtFragment();
                    break;
                default:
                    selectedfragment=new AskDoubtFragment();
                    break;
...
// Commit the transaction
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent intent = new Intent(AskDoubtActivity.this,ProfileActivity.class);
            ...
            FirebaseAuth.AuthStateListener authStateListener = new FirebaseAuth.AuthStateListener() {
                ...
                public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                    if (firebaseAuth.getCurrentUser() == null){
                        ...
                        Intent intent = new Intent(AskDoubtActivity.this,MainActivity.class);
                        startActivity(intent);
                    }
                    else {
                    }
...
//Call signOut()
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id==R.id.nav_gallery)
        {
            ...
            Intent intent = new Intent(AskDoubtActivity.this,NotesActivity.class);
            startActivity(intent);
